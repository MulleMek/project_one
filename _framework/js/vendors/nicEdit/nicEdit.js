...
var nicEditorConfig = bkClass.extend({
	buttons: {
		...
		'left': {
			name: __('Выровнить слева'),
			command: 'justifyleft',
			noActive: true
		},
		'center': {
			name: __('Выровнить по центру'),
			command: 'justifycenter',
			noActive: true
		},
		'right': {
			name: __('Выровнить справа'),
			command: 'justifyright',
			noActive: true
		},
		'justify': {
			name: __('Выровнить по всей строке'),
			command: 'justifyfull',
			noActive: true
		},
		'ol': {
			name: __('Нумерованный список'),
		...
		'indent': {
			name: __('Задать абзац'),
			command: 'indent',
			noActive: true
		},
		'outdent': {
			name: __('Убрать абзац'),
			command: 'outdent',
			noActive: true
		},
		'hr': {
	...
	iconsPath: '/admin/public/pics/nicEditorIcons.gif',
...
var nicColorOptions = {
	buttons: {
		...
		'bgcolor': {
			name: __('Цвет заднего фона текста'),
